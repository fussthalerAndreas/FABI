...
void sendBTKeyboardReport() 
{
	if(DebugOutput == 1)
	{
		Serial.println(F("BT keyboard actions:"));
		Serial.print(F("modifier: 0x"));
		Serial.println(activeModifierKeys,HEX);
		Serial.println(F("activeKeyCodes: "));
...
void initBluetooth()
{
	if(DebugOutput==1) Serial.println("init Bluetooth");
